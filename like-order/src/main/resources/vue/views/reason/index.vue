    ...
    <div class="index-lists">
            ...
            <el-form ref="formRef" class="mb-[-16px]" :model="queryParams" :inline="true">
                ...
                <el-form-item>
                    ...
                    <el-button
                       ...
                       >批量删除</el-button>
                    <el-button v-perms="['reason:add']" type="primary" @click="handleAdd()">
                        <template #icon>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            ...
            <el-table-column type="selection" width="55" header-align="center" align="center"/>
                <el-table-column label="退货原因名" prop="name" min-width="100" header-align="center" align="center"/>
...
<script lang="ts" setup name="reason">
import { reasonDeleteBatch, reasonLists } from '@/api/order/reason'
import { usePaging } from '@/hooks/usePaging'
import feedback from '@/utils/feedback'
import EditPopup from './reason_edit.vue'
