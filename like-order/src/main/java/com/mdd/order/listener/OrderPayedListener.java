...
import com.mdd.order.config.AlipayTemplate;
...
public class OrderPayedListener {
    ...
    public String handleAlipayed(PayAsyncVo asyncVo, HttpServletRequest request) throws AlipayApiException, UnsupportedEncodingException {
        ...
        if (signVerified) {
            ...
            //去修改订单状态
            String result = iOrderService.handlePayResult(asyncVo);
            return result;
        } else {
    ...
    public String asyncNotify(@RequestBody String notifyData) {
        //异步通知结果
        return iOrderService.asyncNotify(notifyData);
    }
}
