    ...
    <div class="index-lists">
        <el-card class="!border-none" shadow="never">
            <el-form ref="formRef" class="mb-[-16px]" :model="queryParams" :inline="true">
                <el-form-item label="会员等级id" prop="levelId">
                    <el-input class="w-[280px]" v-model="queryParams.levelId" />
                </el-form-item>
                ...
                <el-form-item label="性别" prop="gender">
                    <el-input class="w-[280px]" v-model="queryParams.gender" />
                </el-form-item>
                ...
                <el-form-item label="积分" prop="integration">
                    <el-input class="w-[280px]" v-model="queryParams.integration" />
                </el-form-item>
                <el-form-item label="成长值" prop="growth">
                    <el-input class="w-[280px]" v-model="queryParams.growth" />
                </el-form-item>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            ...
            <el-table
                ...
                :data="pager.lists"
            >
                <el-table-column label="会员等级id" prop="levelId" min-width="100" />
                ...
                <el-table-column label="头像" prop="header" min-width="100" />
                <el-table-column label="性别" prop="gender" min-width="100" />
                <el-table-column label="生日" prop="birth" min-width="100" />
                <el-table-column label="所在城市" prop="city" min-width="100" />
                <el-table-column label="职业" prop="job" min-width="100" />
                <el-table-column label="个性签名" prop="sign" min-width="100" />
                <el-table-column label="用户来源" prop="sourceType" min-width="100" />
                <el-table-column label="积分" prop="integration" min-width="100" />
                <el-table-column label="成长值" prop="growth" min-width="100" />
                <el-table-column label="启用状态" prop="status" min-width="100" />
                <el-table-column label="注册时间" prop="createTime" min-width="100" />
