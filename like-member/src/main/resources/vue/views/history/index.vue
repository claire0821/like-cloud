    ...
    <div class="index-lists">
            ...
            <el-form ref="formRef" class="mb-[-16px]" :model="queryParams" :inline="true">
                ...
                <el-form-item label="来源[0->购物；1->管理员修改;2->活动]" prop="sourceTyoe">
                    <template #default="scope">
                        <el-icon v-if="scope.row.sourceTyoe == 1"><SuccessFilled /></el-icon>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            ...
            <el-table-column type="selection" width="55" header-align="center" align="center"/>
                ...
                <el-table-column label="变化的值" prop="changeCount" min-width="100" header-align="center" align="center"/>
                <el-table-column label="备注" prop="note" min-width="100" header-align="center" align="center"/>
                <el-table-column label="来源[0->购物；1->管理员修改;2->活动]" prop="sourceTyoe" min-width="100" header-align="center" align="center"/>
...
import { historyDeleteBatch, historyLists } from '@/api/member/history'
