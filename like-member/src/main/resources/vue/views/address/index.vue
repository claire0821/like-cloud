    ...
    <div class="index-lists">
        ...
        <el-card class="!border-none mt-4" shadow="never">
            ...
            >
                ...
                <el-table-column label="收货人姓名" prop="name" min-width="100" />
                <el-table-column label="电话" prop="phone" min-width="100" />
                <el-table-column label="邮政编码" prop="postCode" min-width="100" />
                <el-table-column label="省份/直辖市" prop="province" min-width="100" />
                <el-table-column label="城市" prop="city" min-width="100" />
                <el-table-column label="区" prop="region" min-width="100" />
                <el-table-column label="详细地址(街道)" prop="detailAddress" min-width="100" />
                <el-table-column label="省市区代码" prop="areacode" min-width="100" />
                <el-table-column label="是否默认" prop="defaultStatus" min-width="100" />
...
import { addressDelete, addressLists } from '@/api/address'
