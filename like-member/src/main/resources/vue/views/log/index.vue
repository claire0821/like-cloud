    ...
    <div class="index-lists">
        ...
        <el-card class="!border-none mt-4" shadow="never">
            ...
            <el-table-column type="selection" width="55" header-align="center" align="center"/>
                ...
                <el-table-column label="ip" prop="ip" min-width="100" header-align="center" align="center"/>
                <el-table-column label="city" prop="city" min-width="100" header-align="center" align="center"/>
                <el-table-column label="登录类型[1-web，2-app]" prop="loginType" min-width="100" header-align="center" align="center"/>
...
import { logDeleteBatch, logLists } from '@/api/member/log'
