    ...
    <div class="index-lists">
        ...
        <el-card class="!border-none mt-4" shadow="never">
            ...
            <el-table-column type="selection" width="55" header-align="center" align="center"/>
                <el-table-column label="仓库名" prop="name" min-width="100" header-align="center" align="center"/>
                <el-table-column label="仓库地址" prop="address" min-width="100" header-align="center" align="center"/>
                <el-table-column label="区域编码" prop="areacode" min-width="100" header-align="center" align="center"/>
...
import { infoDeleteBatch, infoLists } from '@/api/wave/info'
