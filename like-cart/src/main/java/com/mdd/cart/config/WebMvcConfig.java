package com.mdd.cart.config;

import com.mdd.cart.LikeCartInterceptor;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    @Resource
    LikeCartInterceptor likeCartInterceptor;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(likeCartInterceptor).addPathPatterns("/**");
    }
