    ...
    <div class="index-lists">
        ...
        <el-card class="!border-none mt-4" shadow="never">
            ...
            <el-table-column type="selection" width="55" header-align="center" align="center"/>
                <el-table-column label="优惠券id" prop="couponId" min-width="100" header-align="center" align="center"/>
                <el-table-column label="会员id" prop="memberId" min-width="100" header-align="center" align="center"/>
                <el-table-column label="会员名字" prop="memberNickName" min-width="100" header-align="center" align="center"/>
                <el-table-column label="获取方式[0->后台赠送；1->主动领取]" prop="getType" min-width="100" header-align="center" align="center"/>
                <el-table-column label="创建时间" prop="createTime" min-width="100" header-align="center" align="center"/>
                <el-table-column label="使用状态[0->未使用；1->已使用；2->已过期]" prop="useType" min-width="100" header-align="center" align="center"/>
                <el-table-column label="使用时间" prop="useTime" min-width="100" header-align="center" align="center"/>
                <el-table-column label="订单id" prop="orderId" min-width="100" header-align="center" align="center"/>
                <el-table-column label="订单号" prop="orderSn" min-width="100" header-align="center" align="center"/>
