    ...
    <div class="index-lists">
            ...
            <el-form ref="formRef" class="mb-[-16px]" :model="queryParams" :inline="true">
                ...
                <el-form-item>
                    ...
                    <el-button
                       ...
                       >批量删除</el-button>
                    <el-button v-perms="['spu:add']" type="primary" @click="handleAdd()">
                        <template #icon>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            ...
            <el-table-column type="selection" width="55" header-align="center" align="center"/>
                ...
                <el-table-column label="专题id" prop="subjectId" min-width="100" header-align="center" align="center"/>
...
import { spuDeleteBatch, spuLists } from '@/api/coupon/spu'
import { usePaging } from '@/hooks/usePaging'
import feedback from '@/utils/feedback'
import EditPopup from './spu_edit.vue'
